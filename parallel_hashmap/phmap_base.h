...
private:
    ...
    static constexpr bool LayoutCompatible() {
        return std::is_standard_layout<P>() && sizeof(P) == sizeof(Pair) &&
            ...
            OffsetOf<P>::kFirst ==
            OffsetOf<Pair>::kFirst &&
            OffsetOf<P>::kSecond ==
            OffsetOf<Pair>::kSecond;
    }
...
public:
    ...
    static void swap(Allocator* alloc, slot_type* a, slot_type* b) {
        if (kMutableKeys::value) {
            ...
            std::allocator_traits<Allocator>::construct(*alloc, &a->value,
                                                        std::move(b->value));
            std::allocator_traits<Allocator>::destroy(*alloc, &b->value);
            std::allocator_traits<Allocator>::construct(*alloc, &b->value,
                                                        std::move(tmp));
        }
    }
    ...
    static void move(Allocator* alloc, slot_type* src, slot_type* dest) {
        if (kMutableKeys::value) {
            ...
            std::allocator_traits<Allocator>::construct(*alloc, &dest->value,
                                                        std::move(src->value));
        }
    }
...
struct Storage 
{
    ...
    explicit constexpr Storage(T&& v) : value(std::forward<T>(v)) {}
    ...
    : ElemT<D, I> 
{
    ...
    constexpr Storage() = default;
    explicit constexpr Storage(T&& v) : T(std::forward<T>(v)) {}
    ...
    : Storage<CompressedTuple<Ts...>, std::integral_constant<size_t, I>::value>... 
{
    ...
    explicit constexpr CompressedTupleImpl(Ts&&... args)
        : Storage<CompressedTuple<Ts...>, I>(std::forward<Ts>(args))... {}
};
...
public:
    ...
    explicit constexpr CompressedTuple(Ts... base)
        : CompressedTuple::CompressedTupleImpl(std::forward<Ts>(base)...) {}
